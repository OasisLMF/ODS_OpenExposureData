...
**MS SQL:** An MS SQL schema was originally developed with OED. However, it is not considered the most appropriate technology to use with ODS and although it can continue to be used, it will no longer be supported or maintained. A more extenisble and flexible technology for ODS is being considered.
