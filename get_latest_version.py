"""
This file gets the latest version of the package from PyPi.
"""
import os
import pathlib
...
def get_latest_version_number() -> str:
    ...
    """
    req = requests.get("https://pypi.org/pypi/{{PACKAGE_NAME_HERE}}/json")
...
def write_version_to_file(version_number: str) -> None:
    ...
    Returns: None
    """
    version_file_path: str = str(pathlib.Path(__file__).parent.absolute()) + "/opends/version.py"
