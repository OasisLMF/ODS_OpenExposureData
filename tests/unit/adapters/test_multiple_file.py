...
EXPECTED_OUTCOME = [
    ...
    'range field check passed for file Acc',
    ...
    'valid field check passed for file Acc',
    'required fields check passed for file Acc',
    'correct data types check passed for file Acc',
    'range field check passed for file Acc',
    'valid field check passed for file Loc',
    'required fields check passed for file Loc',
    'correct data types check passed for file Loc',
    'range field check passed for file Loc',
    'valid field check passed for file ReinsInfo',
