...
GeogScheme codes are up to five characters (no special characters). The current coded values are listed in the :doc:`coded values reference <../reference/values>`, including the per-country area codes.
